...
namespace fastdist::math {
    ...
    py::array_t<double> poisson_mgf_cpu_wrapper(const py::array_t<double>& t, double lambda, int stepSize = 0);
    py::array_t<double> poisson_cgf_cpu_wrapper(const py::array_t<double>& t, double lambda, int stepSize = 0);
    ...
    py::array_t<double> poisson_mgf_cuda_wrapper(const py::array_t<double>& t, double lambda, int stepSize = 0);
    py::array_t<double> poisson_cgf_cuda_wrapper(const py::array_t<double>& t, double lambda, int stepSize = 0);
#endif

...
extern "C" double fd_chi_square_pdf(const double x, const double k) {
    return fastdist::math::chi_square_pdf_scalar(x, k);
}

extern "C" double fd_chi_square_cdf(const double x, const double k) {
...
extern "C" double fd_chi_square_mgf(const double t, const double k) {
    return fastdist::math::chi_square_mgf_scalar(t, k);
}

extern "C" double fd_chi_square_cgf(const double t, const double k) {

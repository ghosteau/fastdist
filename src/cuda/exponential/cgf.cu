...
namespace fastdist::cuda::exponential {
    // CUDA kernel
    __global__ void exponential_cgf_kernel(const double* t, double* output, const int n, const double lambda, const double stepSize, const int offset) {
    ...
    // Dispatcher
    void exponential_cgf_dispatcher(const double* t, double* output, const int n, const double lambda, const double stepSize) {
